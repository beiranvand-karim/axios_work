...
export  default function AboutTop() {
    ...
    return (
        ...
        <div className="about-top-component banner flex-center flex-justify flex-column center">

            <h1 className="em-100 white uppercase lm-title lh1 lh1-tablet mtl">
                We are on a mission
            </h1>

            <p className="first em-300 light-blue type-h5 ptm container-xs mbml hidden-xs">
            ...
            <p className="second em-300 light-blue type-h5 ptm container-xs mbml visible-xs">
