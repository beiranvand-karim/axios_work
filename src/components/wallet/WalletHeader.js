            ...
            <div className="wrapper">
                ...
                <nav className="short opaque">
                    ...
                    <ul className="igation">
                        ...
                        <li className="second hidden-sm hidden-xs flex-space">

                        </li>

                        <li className="third hidden-sm hidden-xs whats-new item hidden-xs dropdown dropdown-toggle">
                        ...
                        <li className="fourth hidden-sm hidden-xs ml-25 item">

                            <a href="">
                                <img className="first" src={refresh} alt=""/>
                                <img className="second" src={refreshDev} alt=""/>
                            </a>
                        </li>

                        <li className="fifth hidden-sm hidden-xs ml-25 item">
